...
/// Observation bridge for `game_set_d2gs()` -- binds the
...
/// Observation bridge for `game_set_created()` -- flips
...
/// Observation bridge for `game_add_character()` -- fires
...
/// Observation bridge for `game_del_character()` -- fires
