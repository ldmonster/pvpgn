...
/// R232(2) -- observation-only strangler-fig bridges for the legacy
...
///     `dbs_on_exit()`.
///
/// Both bridges layer structured telemetry so a v3-native d2dbs
/// runtime can later be swapped in behind a single flip.
///
