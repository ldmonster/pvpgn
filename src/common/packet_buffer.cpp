 ...
 */
// packet_buffer.cpp — packet lifecycle, class, type, size, flags, header-size
// Responsibility: buffer management and metadata accessors (SOLID-S split from packet.cpp)
