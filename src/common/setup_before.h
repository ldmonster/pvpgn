...
const unsigned BNETD_V3_TCP_SESSION_MODE = 0; /* When non-zero, accepted bnet TCP sockets are owned by a TcpSession instead of legacy fdwatch (scaffolding only). */
