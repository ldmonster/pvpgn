...
namespace pvpgn
{
	...
	#define safe_toupper(X) (std::islower(static_cast<unsigned char>(X))?std::toupper(static_cast<unsigned char>(X)):(X))
	#define safe_tolower(X) (std::isupper(static_cast<unsigned char>(X))?std::tolower(static_cast<unsigned char>(X)):(X))
