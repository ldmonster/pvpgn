...
TEST_CASE("infoply: server_tag_for maps the five known tags",
...
TEST_CASE("infoply: server_tag_for rejects unknown tag",
          "[application][anongame_infoply]") {
...
TEST_CASE("infoply: URL single-tag round-trip",
          "[application][anongame_infoply]") {
...
TEST_CASE("infoply: MAP / TYPE / DESC / LADR round-trips",
          "[application][anongame_infoply]") {
    auto snap = make_full_snapshot();
...
TEST_CASE("infoply: missing snapshot payload -> NotFound",
          "[application][anongame_infoply]") {
...
TEST_CASE("infoply: full INFOREQ produces ordered replies with trailing flags",
          "[application][anongame_infoply]") {
    auto snap = make_full_snapshot();
...
TEST_CASE("infoply: missing tags in snapshot are silently skipped",
          "[application][anongame_infoply]") {
...
TEST_CASE("infoply: empty request yields empty reply set",
          "[application][anongame_infoply]") {
    pb::AnonGameInfoRequest req{};
    req.count   = 0;
    req.noitems = 0;
...
TEST_CASE("infoply: unknown tag in request -> InvalidArgument",
          "[application][anongame_infoply]") {
    pb::AnonGameInfoRequest req{};
    req.count   = 1;
    req.noitems = 1;
...
TEST_CASE("infoply: encode_inforeply_packet starts with 0xFF 0x44 + length",
          "[application][anongame_infoply]") {
    auto snap = make_full_snapshot();
    auto reply = build_inforeply_for_tag(
...
TEST_CASE("infoply: encode_inforeply_packet round-trips via parse",
          "[application][anongame_infoply]") {
    auto snap = make_full_snapshot();
    auto reply = build_inforeply_for_tag(
...
TEST_CASE("infoply: encode_inforeply_packets concatenates N packets",
          "[application][anongame_infoply]") {
    auto snap = make_full_snapshot();
    pb::AnonGameInfoRequest req{};
    req.count   = 1;
...
TEST_CASE("infoply: encode_inforeplies_for_request empty -> empty bytes",
          "[application][anongame_infoply]") {
    AnonGameInfoSnapshot empty;
    pb::AnonGameInfoRequest req{};
    req.count   = 1;
...
TEST_CASE("infoply: compile_snapshot populates only the present tags",
...
TEST_CASE("infoply: compiled build_inforeply_for_tag missing -> NotFound",
          "[application][anongame_infoply][compiled]") {
...
TEST_CASE("infoply: compiled unknown tag -> InvalidArgument",
          "[application][anongame_infoply][compiled]") {
...
TEST_CASE("infoply: compiled fan-out skips missing tags & sets trailing flags",
          "[application][anongame_infoply][compiled]") {
    AnonGameInfoSnapshot partial;
    partial.url = pb::AnonGameUrlPayload{{"a", "b", "c"}};
    partial.map = pb::AnonGameMapPayload{{"only-map"}};
...
TEST_CASE("infoply: compile_snapshot_set compiles default and all locales",
          "[application][anongame_infoply][compiled][multilocale]") {
...
TEST_CASE("infoply: CompiledSnapshotSet::select returns locale or default",
          "[application][anongame_infoply][compiled][multilocale]") {
    AnonGameInfoSnapshot def;
...
TEST_CASE("infoply: compile_snapshot_set with empty locale map mirrors default",
          "[application][anongame_infoply][compiled][multilocale]") {
    AnonGameInfoSnapshot def;
...
TEST_CASE("infoply: CompiledSnapshotSet feeds existing compiled-API encode path",
          "[application][anongame_infoply][compiled][multilocale]") {
    AnonGameInfoSnapshot def;
