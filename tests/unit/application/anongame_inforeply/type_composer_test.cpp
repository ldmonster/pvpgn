...
using pvpgn::application::anongame_inforeply::compose_type_payload;
using pvpgn::application::anongame_inforeply::kAnonGameDefaultPrefix;
using pvpgn::application::anongame_inforeply::kAnonGameQueueCount;
...
TEST_CASE("type_composer: empty input -> empty payload",
          "[application][anongame_inforeply][type]") {
