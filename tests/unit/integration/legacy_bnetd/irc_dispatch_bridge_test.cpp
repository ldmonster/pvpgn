...
#include "integration/legacy_bnetd/irc_dispatch_bridge.hpp"
...
TEST_CASE("irc dispatch bridge null conn no-op",
...
TEST_CASE("irc dispatch bridge logs con_command",
          "[integration][legacy_bnetd][irc_dispatch_bridge]") {
    int marker = 0;
    RecordingLogger sink;
    ila::BridgeLoggerOverride guard(sink);
...
TEST_CASE("irc dispatch bridge logs log_command",
          "[integration][legacy_bnetd][irc_dispatch_bridge]") {
    int marker = 0;
    RecordingLogger sink;
    ila::BridgeLoggerOverride guard(sink);
...
TEST_CASE("irc dispatch bridge logs welcome",
          "[integration][legacy_bnetd][irc_dispatch_bridge]") {
    int marker = 0;
    RecordingLogger sink;
    ila::BridgeLoggerOverride guard(sink);
...
TEST_CASE("irc dispatch bridge null op normalised",
          "[integration][legacy_bnetd][irc_dispatch_bridge]") {
    int marker = 0;
    RecordingLogger sink;
    ila::BridgeLoggerOverride guard(sink);
