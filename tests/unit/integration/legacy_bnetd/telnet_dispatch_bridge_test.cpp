...
#include "integration/legacy_bnetd/telnet_dispatch_bridge.hpp"
...
TEST_CASE("telnet dispatch bridge null conn no-op",
...
TEST_CASE("telnet dispatch bridge logs connected state",
          "[integration][legacy_bnetd][telnet_dispatch_bridge]") {
    int marker = 0;
    RecordingLogger sink;
    ila::BridgeLoggerOverride guard(sink);
...
TEST_CASE("telnet dispatch bridge logs bot_username state",
          "[integration][legacy_bnetd][telnet_dispatch_bridge]") {
    int marker = 0;
    RecordingLogger sink;
    ila::BridgeLoggerOverride guard(sink);
...
TEST_CASE("telnet dispatch bridge logs bot_password state",
          "[integration][legacy_bnetd][telnet_dispatch_bridge]") {
    int marker = 0;
    RecordingLogger sink;
    ila::BridgeLoggerOverride guard(sink);
...
TEST_CASE("telnet dispatch bridge logs loggedin state",
          "[integration][legacy_bnetd][telnet_dispatch_bridge]") {
    int marker = 0;
    RecordingLogger sink;
    ila::BridgeLoggerOverride guard(sink);
...
TEST_CASE("telnet dispatch bridge null op normalised",
          "[integration][legacy_bnetd][telnet_dispatch_bridge]") {
    int marker = 0;
    RecordingLogger sink;
    ila::BridgeLoggerOverride guard(sink);
...
TEST_CASE("telnet dispatch bridge empty op normalised",
          "[integration][legacy_bnetd][telnet_dispatch_bridge]") {
    int marker = 0;
    RecordingLogger sink;
    ila::BridgeLoggerOverride guard(sink);
